        ...
        <div className="dashboard">
            <section className="section1">
                <div className="container">
                    <div className="heading1"><span>Dashboard</span></div>
                    <div className="buttons">
                        <Link to="/"><span className="w-btn-label">Home <i className="fa-solid fa-chevron-right"></i></span></Link>
                        <Link to="/dashboard"><span className="w-btn-label">Dahboard</span></Link>
                    </div>
                </div>
            </section>
            ...
            <section className="section2">
                <div className="container">
                    ...
                    <div className="buttons">
                        <div>
                            <Link to="/services"><span className="w-btn-label">View Services</span></Link>
                        </div>
                        <div>
