...
function PersonDetail() {
    ...
    const person = MeetTeamData.find(p => 
        p.person.toLowerCase().replace(/\s+/g, '-') === personId
    );
        ...
        <div className="persons bookoapp">
            <section className="row mx-0 section1">
                ...
                <div className="col-md-6 sub-container2">
                    <h3><span className="heading">About {person.person}</span></h3>
                    ...
                    <div className="buttons">
                        ...
                        <button 
                            className={`btn ${activeTab === 'clinicalInterests' ? 'active' : ''}`} 
                    ...
                    <div className="content">
                        ...
                        {activeTab === 'clinicalInterests' && (
                            <div>
                                {person.clinicalInterests.map((interest, index) => (
