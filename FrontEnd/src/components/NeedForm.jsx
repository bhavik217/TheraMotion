  ...
  return (
    <div className="needformo">
      ...
      <form>
        ...
        <div className="emai">
          <h5>Email</h5>
          <input type="email" className="inp" required /><br />
          <p className="reqd">This is the required field</p>
        </div>
        <div className="mess">
          <h5>Message</h5>
          <textarea className="inp" required /><br />
          <p className="reqd">This is the required field</p>
        </div>
        <div className="submit">
          <button className="bsub" type="submit">SUBMIT</button><br />
          <p className="psub">Please Enter Correct Information before Submitting form</p>
        </div>
      </form>
    </div>
  );
